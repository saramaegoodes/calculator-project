    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonEqual_Click(object sender, EventArgs e)
        {
            ...
            switch(operation)
            {
                ...
                //SquareRoot
                case "SqRt":
                    answer.Text = (Math.Sqrt(Convert.ToDouble(value))).ToString();
                    break;

                //Square
                case "Squared":
                    answer.Text = (Math.Pow(value, Double.Parse(answer.Text))).ToString();
                    break;

                //Sin
                case "Sin":
                    answer.Text = (Math.Sin(Convert.ToDouble(value))).ToString();
                    break;

                //Cos
                case "Cos":
                    answer.Text = (Math.Cos(Convert.ToDouble(value))).ToString();
                    break;

                //Tan
                case "Tan":
                    answer.Text = (Math.Tan(Convert.ToDouble(value))).ToString();
                    break;
